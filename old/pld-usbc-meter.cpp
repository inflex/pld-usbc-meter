...
int main ( int argc, char **argv ) {
	...
	while (!quit) {
		...
		linetmp[0] = '\0';
			...
			if (current < 0) snprintf(line1, sizeof(line1), "**NC**");
			else snprintf(line1, sizeof(line1), "%0.1fmA", current);

			if (voltage < 0.1) snprintf(line2, sizeof(line2), "**NC**");
			else snprintf(line2, sizeof(line2), "%0.1fV", voltage);
